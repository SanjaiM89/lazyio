...
import { scanTelegramChannel, refreshHomepage, recordPlay, deleteSong } from './api';
...
const Home = ({ data, onPlaySong, onNavigate, onRefresh, onOpenPlaylistModal }) => {
    ...
    const handleRefresh = async () => {
        setRefreshing(true);
        try {
            // Force Telegram channel scan to fetch new songs
            await scanTelegramChannel(true);
            await refreshHomepage();
            onRefresh?.();
        } catch (err) {
            console.error('Telegram scan/refresh failed:', err);
        } finally {
            setRefreshing(false);
        }
    };
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    >
                        ...
                        {refreshing ? 'Scanning Telegram...' : 'Refresh'}
                    </button>
                </div>
