      ...
      child: Column(
        ...
        children: [
          ...
          if (recentSongs.isNotEmpty) ...[
            const Text("Recently Played", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ...
                          Expanded(
                            child: ClipRRect(
                              ...
                              child: song.coverArt != null
                                  ? Image.network(song.coverArt!, fit: BoxFit.cover, width: 120)
                                  : Container(color: Colors.white10, child: const Icon(Icons.music_note, size: 40, color: Colors.white24)),
                            ),
                          ),
                          const SizedBox(height: 8),
                          Text(song.title, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontWeight: FontWeight.bold)),
                          Text(song.artist, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white54, fontSize: 12)),
                        ],
                      ),
                    ),
                  );
              ...
              child: Column(
                children: aiSongs.take(5).map((song) => ListTile(
                  ...
                  leading: ClipRRect(
                    ...
                    child: song.coverArt != null
                        ? Image.network(song.coverArt!, width: 40, height: 40, fit: BoxFit.cover)
                  ...
                  trailing: Text("${(song.duration/60).floor()}:${(song.duration%60).toInt().toString().padStart(2,'0')}", 
